...
// รัน: node seocenter.test.js [path ของ nj-survey-system]
// ⚠️ ชื่อไฟล์นี้เคยเป็น seo.test.js — เปลี่ยนตอนรวมกับ main เพราะรอบ UX มี seo.test.js ของตัวเอง
//    (ตัวนั้นตรวจผลลัพธ์ที่ commit ไว้ · ตัวนี้ตรวจ build/seo.js ซึ่งเป็นตัวสร้าง)
