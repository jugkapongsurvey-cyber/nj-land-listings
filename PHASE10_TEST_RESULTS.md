...
### รอเจ้าของกิจการ
1. ~~**ยืนยันสิทธิ์ Google Search Console**~~ ✅ ยืนยันแล้ว + ส่งแผนผังครบ 3 ไฟล์ 25 ก.ย. (`PHASE10_DEPLOYMENT_GUIDE.md` ข้อ 5.1)
...
4. ~~**อนุมัติสร้างหน้าแปลงสแตติกใหม่**~~ ✅ เสร็จแล้ว 25 ก.ย. (#28) — — หน้าแปลงยังเป็นรุ่น 21 ก.ย. (ยังดึงฟอนต์ภายนอก · ดูรายงานประสิทธิภาพข้อ 4)
...
2. ~~**Action สร้างหน้าแปลงอัตโนมัติ**~~ ✅ ทำแล้ว (`properties.yml`) — แบบเดียวกับบทความและวารสาร — หน้าแปลงจะไม่ค้างรุ่นเก่าอีก
