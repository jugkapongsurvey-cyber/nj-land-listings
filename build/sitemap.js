...
//    ⚠️ ไฟล์นี้อ่านเฉพาะ `.html` ที่ "รากเว็บ" เท่านั้น จึงไม่เก็บ `properties/**/index.html`
//       (หน้าแปลงชุดใหม่) และไม่เก็บ `p/*.html` (หน้าพาไปที่อยู่ใหม่) ซึ่งถูกต้องแล้ว —
//       หน้าพาไปห้ามอยู่ในแผนผัง เพราะแผนผังคือรายการหน้าที่เราอยากให้เก็บเข้าดัชนี
...
const SKIP = {
  'land.html': 'หน้าแปลงรายแปลง — ชี้ canonical ไป /properties/…/{รหัส}/ ซึ่งอยู่ใน sitemaps/properties.xml แล้ว',
