...
//
// 4. **หน้าแปลงที่ดินรายแปลงยังไม่อยู่ในไฟล์นี้** — จะมาพร้อม sitemaps/properties.xml
//    ที่สร้างจากข้อมูลจริงของ API (Phase 10 สปรินต์ 3) · หน้าเหล่านั้นเป็น land.html?id=…
//    ซึ่งวันนี้ยังส่ง HTML เปล่าให้บอต (ดู PHASE10_SEO_AUDIT.md ข้อ C2)
//
...
const SKIP = {
  'land.html': 'หน้าแปลงรายแปลง — รอ sitemaps/properties.xml ที่สร้างจากข้อมูลจริง (สปรินต์ 3)',
