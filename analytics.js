...
var NJ_INTERNAL_EVENTS = ['pageview', 'line_click', 'tel_click', 'messenger_click', 'consign_view', 'consign_submit', 'consign_files',
                          ...
                          'lead_tool_preview',
                          // เริ่มใช้เครื่องมืออีก 4 ตัว (ติ๊กข้อแรก / แตะช่องกรอกครั้งแรก · ครั้งเดียวต่อการเปิดหน้า)
                          // ตัวหารอัตราแปลงของเครื่องมือนั้น · **ไม่ใช่ลีด** · ต้องมีใน PUBLIC_EVENT_TYPES ของ server.js ด้วย
                          'lead_tool_price_start', 'lead_tool_checklist_start', 'lead_tool_sample_start', 'lead_tool_news_start'];
