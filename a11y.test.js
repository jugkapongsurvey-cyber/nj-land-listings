...
PAGES.forEach(f => {
  ...
  // สองหน้านี้วาด h1 ด้วย JS หลังโหลดข้อมูล — ตรวจแล้วว่าไฟล์ JS ของมันสร้าง <h1> จริง
  //   land.html          → ชื่อแปลง (หน้าสแตติก p/*.html มีใน HTML ต้นทางแล้ว)
  //   package-order.html → สถานะใบสั่งงาน (หน้าติดตามที่ใช้ตั๋ว · noindex)
  if (f === 'land.html' || f === 'package-order.html') {
    ok(f + ': h1 มาจาก JS (ยอมรับได้)', n === 0, 'เจอ ' + n); return;
  }
